...
:cmake:variable:`JCM_<LANG>_UNIT_TEST_SOURCE_EXTENSION`
...
set(JCM_CXX_UNIT_TEST_SOURCE_EXTENSION ".test${JCM_CXX_SOURCE_EXTENSION}")
set(JCM_CXX_UTEST_SOURCE_EXTENSION "${JCM_CXX_UNIT_TEST_SOURCE_EXTENSION}")

set(JCM_C_HEADER_EXTENSION ".h")
set(JCM_C_SOURCE_EXTENSION ".c")
set(JCM_C_UNIT_TEST_SOURCE_EXTENSION ".test${JCM_C_SOURCE_EXTENSION}")
set(JCM_C_UTEST_SOURCE_EXTENSION "${JCM_C_UNIT_TEST_SOURCE_EXTENSION}")

set(JCM_CUDA_HEADER_EXTENSION ".cuh")
set(JCM_CUDA_SOURCE_EXTENSION ".cu")
set(JCM_CUDA_UNIT_TEST_SOURCE_EXTENSION ".test${JCM_CUDA_SOURCE_EXTENSION}")
set(JCM_CUDA_UTEST_SOURCE_EXTENSION "${JCM_CUDA_UNIT_TEST_SOURCE_EXTENSION}")

set(JCM_OBJC_HEADER_EXTENSION ".h")
set(JCM_OBJC_SOURCE_EXTENSION ".m")
set(JCM_OBJC_UNIT_TEST_SOURCE_EXTENSION ".test${JCM_OBJC_SOURCE_EXTENSION}")
set(JCM_OBJC_UTEST_SOURCE_EXTENSION "${JCM_OBJC_UNIT_TEST_SOURCE_EXTENSION}")

set(JCM_OBJCXX_HEADER_EXTENSION ".h")
set(JCM_OBJCXX_SOURCE_EXTENSION ".mm")
set(JCM_OBJCXX_UNIT_TEST_SOURCE_EXTENSION ".test${JCM_OBJCXX_SOURCE_EXTENSION}")
set(JCM_OBJCXX_UTEST_SOURCE_EXTENSION "${JCM_OBJCXX_UNIT_TEST_SOURCE_EXTENSION}")

set(JCM_HIP_HEADER_EXTENSION ".hpp")
set(JCM_HIP_SOURCE_EXTENSION ".cpp")
set(JCM_HIP_UNIT_TEST_SOURCE_EXTENSION ".test${JCM_HIP_SOURCE_EXTENSION}")
set(JCM_HIP_UTEST_SOURCE_EXTENSION "${JCM_HIP_UNIT_TEST_SOURCE_EXTENSION}")
