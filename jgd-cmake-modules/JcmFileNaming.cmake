...
- :cmake:variable:`JCM_<LANG>_UNIT_TEST_SOURCE_REGEX`
...
- :cmake:variable:`JCM_UNIT_TEST_SOURCE_REGEX`
...
foreach(ext_var
    ...
    JCM_C_HEADER_EXTENSION JCM_C_SOURCE_EXTENSION JCM_C_UNIT_TEST_SOURCE_EXTENSION JCM_C_UTEST_SOURCE_EXTENSION
    JCM_CUDA_HEADER_EXTENSION JCM_CUDA_SOURCE_EXTENSION JCM_CUDA_UNIT_TEST_SOURCE_EXTENSION JCM_CUDA_UTEST_SOURCE_EXTENSION
    JCM_OBJC_HEADER_EXTENSION JCM_OBJC_SOURCE_EXTENSION JCM_OBJC_UNIT_TEST_SOURCE_EXTENSION JCM_OBJC_UTEST_SOURCE_EXTENSION
    JCM_OBJCXX_HEADER_EXTENSION JCM_OBJCXX_SOURCE_EXTENSION JCM_OBJCXX_UNIT_TEST_SOURCE_EXTENSION JCM_OBJCXX_UTEST_SOURCE_EXTENSION
...
if(_jcm_languages)
  foreach(lang IN LISTS _jcm_languages)
    ...
    list(APPEND JCM_UNIT_TEST_SOURCE_REGEX "${JCM_${lang}_UNIT_TEST_SOURCE_REGEX}")
  ...
  list(REMOVE_DUPLICATES JCM_UNIT_TEST_SOURCE_REGEX)
  list(JOIN JCM_HEADER_REGEX "|" JCM_HEADER_REGEX)
  list(JOIN JCM_SOURCE_REGEX "|" JCM_SOURCE_REGEX)
  list(JOIN JCM_UNIT_TEST_SOURCE_REGEX "|" JCM_UNIT_TEST_SOURCE_REGEX)
  set(JCM_UTEST_SOURCE_REGEX "${JCM_UNIT_TEST_SOURCE_REGEX}")
endif()
