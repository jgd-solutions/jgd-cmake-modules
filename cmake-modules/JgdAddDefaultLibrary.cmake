...
include(JgdGenDefaultLibraryName)

#
# Creates a library with a name generated by JgdGenDefaultLibraryName and the
# default target properties defined in JgdDefaultTargetProps. These include the
# target's output name, compile options, position independent code, and include
# directories.
#
...
function(jgd_add_default_library)
  ...
  if(ARGS_LIBRARY)
    ...
    jgd_gen_default_library_name(${comp_arg} OUT_VAR library)
  endif()
